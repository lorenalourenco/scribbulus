"""
Django settings for scribbulus project.
...
SECRET_KEY = 'django-insecure-zrih!ay%-ui$b520wky^h=1=qkb1k7aahjsr^)e*=@8%+gf8cq'
...
WSGI_APPLICATION = 'scribbulus.wsgi.application'
